...
def get_result():
    ...
    if operator == '+':
        result_label.config(text=str(first_numbver+second_number))
    elif operator == '-':
        result_label.config(text=str(first_numbver-second_number))
    elif operator == '*':
        result_label.config(text=str(first_numbver*second_number))
...
btn_subtract=Button(root,text='-',bg='#00a65a',fg='white',width=5,height=2,command=lambda :get_operator('-'))
...
btn_multiplication=Button(root,text='*',bg='#00a65a',fg='white',width=5,height=2,command=lambda :get_operator('*'))
btn_multiplication.grid(row=3,column=3)
btn_multiplication.config(font=('verdana',14))
